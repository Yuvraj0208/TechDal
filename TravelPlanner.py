...
class TravelPlanner:
    def __init__(self, prompt, ipdata_key, openai_key, openweather_key):
        self.ipdata_key = ipdata_key
    ...
    def get_weather(self):
        ...
        for i in range(self.days):
            ...
            weather_data[i+1] = {
                "source": {
                    "minimum_temperture": source_response['list'][0]['main']['temp_min'],
                    "maximum_temperture": source_response['list'][0]['main']['temp_max'],
                    "pressure": source_response['list'][0]['main']['pressure'],
                    "humidity": source_response['list'][0]['main']['humidity'],
                    "visibility": source_response['list'][0]['visibility'],
                    "wind_speed": source_response['list'][0]['wind']['speed'],
                    "description": source_response['list'][0]['weather'][0]['description'],
                    },
                "destination": {
                    "minimum_temperture": destination_response['list'][0]['main']['temp_min'],
                    "maximum_temperture": destination_response['list'][0]['main']['temp_max'],
                    "pressure": destination_response['list'][0]['main']['pressure'],
                    "humidity": destination_response['list'][0]['main']['humidity'],
                    "visibility": destination_response['list'][0]['visibility'],
                    "wind_speed": destination_response['list'][0]['wind']['speed'],
                    "description": destination_response['list'][0]['weather'][0]['description'],
                    }
            }
